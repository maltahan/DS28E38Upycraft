...
class DS28E38:  
 ...
 # Read status	
    ...
    def read_man_rom_Id(self):
      ...
      """print(
        "MANID:", binascii.hexlify(rx_read_protection_values[7:9]),
        "DEVICE_VERSION", binascii.hexlify(rx_read_protection_values[9:11])
      )"""
      self.crc16 = bytearray(2)
      self.ow.readinto(self.crc16)
      ...
      try:
        ...
        raise Exception('ROM not available')
        
      print("check data integrity server1")
